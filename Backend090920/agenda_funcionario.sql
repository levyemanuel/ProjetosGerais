...
CREATE TABLE `funcionario` (
  ...
  KEY `idFuncionarioSetor_FK_idx` (`idSetor`)
...
INSERT INTO `funcionario` VALUES (5,'Nome1','2',1234,123456789,'nao','987654321',NULL),(6,'Nome2','3',1234,123456789,'sim',NULL,NULL),(7,'Nome3','4',1234,1234567,'sim','',NULL),(8,'Nome4','4',1234,1234567,'sim','',NULL);
